...
(28, 'Rougails saucisses', 'Rougails sausages', 'Le rougail saucisse est un plat traditionnel réunionnais, à base de saucisses de porc ou de poulet préparées à la créole, souvent fumées, mais parfois fraîches. Celles-ci sont ensuite coupées en morceaux, auxquels on ajoute des tomates coupées en petits dés, des oignons émincés, et souvent des piments pour les personnes qui en mangent.', 'Sausage rougail is a traditional Reunionese dish, made with pork or chicken sausages prepared in the Creole style, often smoked, but sometimes fresh. These are then cut into pieces, to which are added diced tomatoes, minced onions, and often peppers for those who eat them.', 'Saucisses, tomates, oignons, huile, ail, piment, riz', 'Sausages, tomatoes, onions, oil, garlic, chilli, rice', './Image/plat/ROUGAIL.jpg', 17),
